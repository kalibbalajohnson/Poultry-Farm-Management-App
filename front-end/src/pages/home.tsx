...
export default function Home() {
  return (
    <div>
      <Navbar />
      <div className="flex flex-col-2 pb-16 min-h-screen bg-gradient-to-r from-blue-100 to-green-100 text-gray-900">
        <div className="bg-white p-10 rounded-lg shadow max-w-md mx-auto mt-10">
        ...
        <div className="flex-grow flex items-center justify-center mt-12 max-w-2xl mx-auto opacity-80">
          <div className="text-left">
            <p className="text-lg text-gray-600 mb-8">
              Track your flock with precision and ease, from eggs to feed.
            </p>
            <img
              src="farm.jpg"
              alt="Poultry Farm"
